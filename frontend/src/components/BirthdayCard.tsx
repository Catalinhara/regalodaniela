    ...
    return (
        <div className="birthday-container">
            ...
            <div className="birthday-card">
                ...
                <h1 className="birthday-title">¡Feliz Cumpleaños Daniela!</h1>
                <p className="birthday-subtitle">Celebrando tus 33 años ✨</p>

                <div className="birthday-message">
                    <p style={{ margin: 0, position: 'relative', zIndex: 1 }}>
                        En este día tan especial, quiero que sepas que eres una persona extraordinaria.
                        Tu luz ilumina la vida de quienes te rodean, y tu presencia hace del mundo
                        un lugar mejor.
                    </p>
                    <p style={{ margin: '1rem 0 0 0', position: 'relative', zIndex: 1 }}>
                        Que estos 33 años estén llenos de momentos mágicos, sueños cumplidos
                        y sonrisas infinitas. ¡Celebremos juntos este hermoso regalo que es tu vida!
                    </p>
                </div>
